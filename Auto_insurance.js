...
if (gender=="male" && (age >= 15 && age <25)){
    monthlyInsurance= vehiclePrice*0.25/12
    }
    else if (gender=="male" && (age > 25 && age <40)){
    monthlyInsurance= vehiclePrice*0.17/12
    }
    else if (gender=="male" && (age > 40 && age <70)){
    monthlyInsurance= vehiclePrice*0.10/12
    }
if (gender=="female" && (age >= 15 && age <25)){
    monthlyInsurance= vehiclePrice*0.20/12
    }
    else if (gender=="female" && (age > 25 && age <40)){
    monthlyInsurance= vehiclePrice*0.15/12
    }
    else if (gender=="female" && (age > 40 && age <70)){
    monthlyInsurance= vehiclePrice*0.10/12
}
            
//output
console.log(`Your monthly insurance will be $${monthlyInsurance.toFixed(2)}`);
